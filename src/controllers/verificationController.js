...
class VerificationController {
    ...
    async sendInitialVerification(req, res) {
        ...
        try {
            ...
            const [status, message] = errorMap[error.message] || [500, 'Failed to check verification status'];
    ...
    async verifyEmail(req, res) {
        try {
            ...
            res.json({
                ...
                redirectUrl: 'http://localhost:3000/onboarding-talent-user',
            ...
            const [status, message] = map[error.message] || [500, 'Verification failed'];
